    ...
    <div className="gridArticles">
      <div className="container">
        <div className="gridArticlesHead">
          <h2 className={`${poppins.className} gridArticlesTitle`}>Random Posts</h2>
        ...
        <div className="articleContainer">
          <article className="article">
            ...
            <div className="articleInformation">
              ...
              <p className={`${klee.className} articleDescription`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
